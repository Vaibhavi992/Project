                    ...
                    <div id="header-carousel" className="carousel slide" data-ride="carousel">
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img className="w-100" src="Assets_Website/img/carousel-1.jpg" alt="Image" />
                            ...
                            <div className="carousel-item">
                                <img className="w-100" src="Assets_Website/img/carousel-2.jpg" alt="Image" />
                                <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div className="p-3" style={{ maxWidth: 900 }}>
                                        <h4 className="text-white text-uppercase mb-md-3">Traditional &amp; Delicious</h4>
                    ...
                    <div className="row bg-primary m-0">
                        <div className="col-md-6 px-0" style={{ minHeight: 500 }}>
                            <div className="position-relative h-100">
                                <img className="position-absolute w-100 h-100" src="Assets_Website/img/promotion.jpg" style={{ objectFit: 'cover' }} />
                    ...
                    <div className="row m-0 portfolio-container">
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                ...
                                <a
                                    ...
                                    href="Assets_Website/img/portfolio-1.jpg"
                        ...
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                ...
                                <a
                                    className="portfolio-btn"
                                    href="Assets_Website/img/portfolio-2.jpg"
                                    data-lightbox="portfolio"
                                >
                                    <i className="fa fa-plus text-primary" style={{ fontSize: '60px' }} />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                ...
                                <a
                                    className="portfolio-btn"
                                    href="Assets_Website/img/portfolio-3.jpg"
                                    data-lightbox="portfolio"
                                >
                                    <i className="fa fa-plus text-primary" style={{ fontSize: '60px' }} />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                ...
                                <a
                                    className="portfolio-btn"
                                    href="Assets_Website/img/portfolio-4.jpg"
                                    data-lightbox="portfolio"
                                >
                                    <i className="fa fa-plus text-primary" style={{ fontSize: '60px' }} />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                ...
                                <a
                                    className="portfolio-btn"
                                    href="Assets_Website/img/portfolio-5.jpg"
                                    data-lightbox="portfolio"
                                >
                                    <i className="fa fa-plus text-primary" style={{ fontSize: '60px' }} />
                                </a>
                        ...
                        <div className="col-lg-4 col-md-6 p-0 portfolio-item">
                            <div className="position-relative overflow-hidden">
                                <img className="Assets_Website/img-fluid w-100" src="Assets_Website/img/portfolio-6.jpg" alt="" />
                                <a
                                    className="portfolio-btn"
